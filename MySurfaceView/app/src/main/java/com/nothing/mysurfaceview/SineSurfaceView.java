...
/**
 * Created by dengshaomin on 2017/9/26.
 */
...
public class SineSurfaceView extends SurfaceView
        implements SurfaceHolder.Callback, Runnable {

    private SurfaceHolder mHolder;
    private Canvas mCanvas;//用于绘图的canvas
    private boolean mIsDrawing;//子线程标志位，用于控制子线程
    private int x = 0;
    private int y = 0;
    private Path mPath;
    ...
    public SineSurfaceView(Context context, AttributeSet attrs, int defStyle) {
