...
public class SuperTextView extends TextView {
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            cornerWeight = corner / (float) dip2px(50);
            cornerWeight = cornerWeight > 0.5 ? (float) 0.5 : cornerWeight;
            leftTopCornerEnable =
    ...
    private void drawSolid(Canvas canvas) {
        ...
        solidRectF.set(strokeWidth / 2, strokeWidth / 2, width - strokeWidth / 2, height - strokeWidth / 2);
