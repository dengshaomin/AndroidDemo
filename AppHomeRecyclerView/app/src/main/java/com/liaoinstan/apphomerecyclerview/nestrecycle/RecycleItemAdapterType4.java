...
public class RecycleItemAdapterType4 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecycleItemAdapterType4(Context context, List<Cheese> results) {
    ...
    private void bind(ItemViewHolder holder, int position){
        x.image().bind(holder.item_recyc_type4_item_img, results.get(position).getImg(),new ImageOptions.Builder().build(),new CustomBitmapLoadCallBack(holder.item_recyc_type4_item_img));
    }
